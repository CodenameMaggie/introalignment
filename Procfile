...
# Podcast outreach cron with MANDATORY Jordan+Atlas verification (runs every 10 minutes = 600 seconds)
podcast: while true; do node cron-podcast-outreach-verified.js; sleep 600; done
