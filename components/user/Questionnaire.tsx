    ...
    <div className="min-h-screen bg-ivory py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="font-serif text-3xl text-burgundy mb-2">Getting to Know You</h1>
          <p className="font-serif italic text-dusty-rose-dark">Take your time. There are no wrong answers.</p>
        </div>
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-sm text-dusty-rose-dark">{Math.round((progress / 40) * 100)}% complete</span>
          </div>
          <div className="w-full bg-dusty-rose-light rounded-full h-2">
            <div
              className="bg-burgundy rounded-full h-2 transition-all duration-500"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
          <h2 className="text-2xl font-serif text-burgundy mb-6 leading-relaxed">
          ...
          <div className="space-y-3">
            {currentQuestion.type === 'multiple_choice' && currentQuestion.answers?.map((answer) => (
              ...
              >
                <span className="text-charcoal group-hover:text-burgundy transition-colors">
                  {answer.text}
                </span>
              </button>
            ))}
                ...
                <div className="flex justify-between gap-2">
                  {Array.from(
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="flex-1 py-3 px-2 rounded-lg border-2 border-ivory-dark hover:border-burgundy hover:bg-burgundy hover:text-white transition-all duration-200 disabled:opacity-50 text-charcoal font-medium"
                    >
                      {num}
                    </button>
                  ))}
        ...
        {/* Brand footer */}
        <div className="text-center">
          <p className="text-sm font-serif italic text-dusty-rose-dark">
